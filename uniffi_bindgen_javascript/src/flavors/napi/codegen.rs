...
impl NapiTarget {
    fn banner(self) -> &'static str {
        match self {
            Self::Node => "// Generated by uniffi-bindgen-napi.",
            Self::Ohos => "// Generated by uniffi-bindgen-ohos.",
        }
    }
...
fn render_rust(ci: &ComponentInterface, target: NapiTarget) -> Result<String> {
...
impl<'a> Generator<'a> {
    fn new(ci: &'a ComponentInterface, target: NapiTarget) -> Self {
        Self { ci, target }
    }
