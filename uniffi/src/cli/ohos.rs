...
const HOST_BUNDLE_SCHEMA_VERSION: u64 = 3;
const FACADE_INVENTORY_SCHEMA_VERSION: u64 = 1;
const HSP_FACADE_AGGREGATE_SCHEMA_VERSION: u64 = 1;
...
fn validate_hsp_facade_contract(bytes: &[u8]) -> Result<String> {
    ...
    if contract.host_composite_identity.len() != 64
        || !contract
            ...
            .all(|byte| byte.is_ascii_hexdigit())
    {
        bail!("HSP facade contract hostCompositeIdentity must be a SHA-256 digest");
    }
